...
ɪ ᴀᴍ  *{}*, ᴀ ꜰᴀꜱᴛ ᴀɴᴅ ᴍᴏᴅᴜʟᴀʀ ɢʀᴏᴜᴘ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ ʙᴀꜱᴇᴅ ᴏɴ ᴛʜᴇ ᴀɴɪᴍᴇ *{}*.
════════════════
‣ ᴜꜱᴇʀꜱ: `{}`
‣ ᴄʜᴀᴛꜱ: `{}`
‣ ᴜᴘᴛɪᴍᴇ: `{}`
════════════════
➛ ᴛʀʏ ᴛʜᴇ /help  ᴛᴏ ᴋɴᴏᴡ ᴍʏ ᴀʙɪʟɪᴛɪᴇꜱ ××
×⋆──────────────⋆×✧
"""
buttons = [
    [
        InlineKeyboardButton(
            text=f"Add 𝐈ϲнικᴀ 𝐍ᴀᴋᴀɴᴏ To Your Group",
            url=f"https://telegram.dog/ichika_xbot?startgroup=true",
        )
    ],
    [
